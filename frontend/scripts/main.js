...
class HostelApp {
    ...
    init() {
        ...
        // Initialize auth manager (check if it exists)
        if (typeof authManager !== 'undefined') {
            authManager.init();
        } else {
            console.error('authManager not defined. Make sure auth.js is loaded before main.js');
        }
        ...
        return `
            ...
            <div class="dashboard-grid">
                ...
                <div class="card fade-in" style="animation-delay: 0.2s">
                    ...
                    <button class="btn btn-primary mt-2" onclick="app.loadPage('allocation')">
